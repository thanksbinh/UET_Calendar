...
- Change B2 to the start date of the calendar (in format Date time)
- Leave B3 as blank (auto fill with start date + 15 weeks)
...
- (Optional) Change color of your calendar
- Other features:
